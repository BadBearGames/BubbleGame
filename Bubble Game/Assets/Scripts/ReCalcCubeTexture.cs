using UnityEngine;
//https://github.com/Dsphar/Cube_Texture_Auto_Repeat_Unity
//No need for steps 3 or 4 if the object isn't changing, it will adjust it in edit mode to properly resize the tiling
